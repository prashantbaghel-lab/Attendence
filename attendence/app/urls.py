...
from .views import UserCreateView, Attendence_log_view, cousre_vieW, users_view,department_view, Student_view,attendence_list_view, course_list_view,user_list_view, department_list_view, student_list_view,Attendence_log_Update_view,course__Update_view, users__Update_view, department__Update_view, Student__Update_view
